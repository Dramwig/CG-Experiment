...
BEGIN_MESSAGE_MAP(CCG3D2021113163王梓翕View, CView)
	...
	ON_COMMAND(ID_UPDATE_MATERIAL, &CCG3D2021113163王梓翕View::OnUpdateMaterial)
	ON_COMMAND(ID_Custom_Materials, &CCG3D2021113163王梓翕View::OnCustomMaterials)
	ON_COMMAND(ID_Custom_point_light_sources, &CCG3D2021113163王梓翕View::OnCustompointlightsources)
	ON_COMMAND(ID_Custom_line_light_source, &CCG3D2021113163王梓翕View::OnCustomlinelightsource)
	ON_COMMAND(ID_Custom_Spotlight, &CCG3D2021113163王梓翕View::OnCustomSpotlight)
	ON_COMMAND(ID_NTN_TIMER1, &CCG3D2021113163王梓翕View::OnNtnTimer1)
	ON_UPDATE_COMMAND_UI(ID_NTN_TIMER1, &CCG3D2021113163王梓翕View::OnUpdateNtnTimer1)
	ON_WM_TIMER()
END_MESSAGE_MAP()
...
void CCG3D2021113163王梓翕View::Ready(CG3DCamera* pCamera)
{
	wglMakeCurrent(mHDC, mHGLRC);
...
//画笔属性 
COLORREF CCG3D2021113163王梓翕View::MaterialColor() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
		return RGB(1, 1, 1);
...
int CCG3D2021113163王梓翕View::MaterialStyle() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
		return 0;
...
void CCG3D2021113163王梓翕View::OnUpdateMaterial()
{
	// TODO: 在此添加命令处理程序代码
	CCG3D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG3D2021113163王梓翕View::OnCustomMaterials()
{
	CCG3D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
	{
...
CGLight* CCG3D2021113163王梓翕View::CustomLight() {
	CCG3D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
	{
		CInputLight dlg;
...
void CCG3D2021113163王梓翕View::OnCustompointlightsources()
{
...
void CCG3D2021113163王梓翕View::OnCustomlinelightsource()
{
	CGLight* light = CustomLight();
	if (light)
...
void CCG3D2021113163王梓翕View::OnCustomSpotlight()
{
	CGLight* light = CustomLight();
	if (light)
...
void CCG3D2021113163王梓翕View::OnNtnTimer1()
{
...
void CCG3D2021113163王梓翕View::OnUpdateNtnTimer1(CCmdUI* pCmdUI)
{
...
void CCG3D2021113163王梓翕View::OnTimer(UINT_PTR nIDEvent)
{
