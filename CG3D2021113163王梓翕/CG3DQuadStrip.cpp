...
IMPLEMENT_SERIAL(CG3DQuadStrip, CG3DRenderable, 1)

CG3DQuadStrip::CG3DQuadStrip()
	: CG3DClosedFoldedLine(CString("CG3DQuadStrip"))
{
	mName.Format(_T("四边形条带-%ld"), sID);
}

CG3DQuadStrip::CG3DQuadStrip(const CG3DQuadStrip& other)
	: CG3DClosedFoldedLine(CString("CG3DQuadStrip"))
{
	mName.Format(_T("四边形条带-%ld"), sID);
}
...
//绘制 
void CG3DQuadStrip::Render(CG3DRenderContext* pRC, CG3DCamera* pCamera)
{
