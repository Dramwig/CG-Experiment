...
IMPLEMENT_SERIAL(CG3DQuad, CG3DRenderable, 1)

CG3DQuad::CG3DQuad()
	: CG3DClosedFoldedLine(CString("CG3DQuad"))
{
	mName.Format(_T("四边形-%ld"), sID);
}

CG3DQuad::CG3DQuad(const CG3DQuad& other)
	: CG3DClosedFoldedLine(CString("CG3DQuad"))
{
	mName.Format(_T("四边形-%ld"), sID);
}
...
//绘制 
void CG3DQuad::Render(CG3DRenderContext* pRC, CG3DCamera* pCamera)
{
