...
IMPLEMENT_SERIAL(CG3DFoldedLine, CG3DRenderable, 1)

CG3DFoldedLine::CG3DFoldedLine()
	: CG3DClosedFoldedLine(CString("CG3DFoldedLine"))
{
	mName.Format(_T("折线-%ld"), sID);
}

CG3DFoldedLine::CG3DFoldedLine(const CG3DFoldedLine& other)
	: CG3DClosedFoldedLine(CString("CG3DFoldedLine"))
{
	mName.Format(_T("折线-%ld"), sID);
}
...
//绘制 
void CG3DFoldedLine::Render(CG3DRenderContext* pRC, CG3DCamera* pCamera)
{
