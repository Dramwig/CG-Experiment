#include "pch.h"
#include "CG2D2021113163王梓翕Doc.h" //包含View之前要包含Doc
#include "CG2D2021113163王梓翕View.h" //用户交互绘制，并将图形对象通过Doc添加到场景
#include "CG2DRenderableMoveCommand.h"

CG2DRenderableMoveCommand::CG2DRenderableMoveCommand(CView* pview/* = nullptr*/, CCG2D2021113163王梓翕Doc* pDoc/* = nullptr*/)
...
int CG2DRenderableMoveCommand::OnLButtonDown(UINT nFlags, CPoint pos)
{
	if (mView == nullptr)
		return -1;
	CCG2D2021113163王梓翕View* view = dynamic_cast<CCG2D2021113163王梓翕View*>(mView);
	if (view == nullptr)
		return -1;
