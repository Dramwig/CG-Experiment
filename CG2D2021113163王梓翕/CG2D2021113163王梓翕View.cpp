...
BEGIN_MESSAGE_MAP(CCG2D2021113163王梓翕View, CView)
	...
	ON_WM_RBUTTONDOWN()
	ON_WM_TIMER()
	ON_COMMAND(ID_DRAW_LINESEGMENT, &CCG2D2021113163王梓翕View::OnDrawLinesegment)
	ON_COMMAND(ID_DRAW_POLYLINE, &CCG2D2021113163王梓翕View::OnDrawPolyline)
	ON_UPDATE_COMMAND_UI(ID_DRAW_LINESEGMENT, &CCG2D2021113163王梓翕View::OnUpdateDrawLinesegment)
	ON_UPDATE_COMMAND_UI(ID_DRAW_POLYLINE, &CCG2D2021113163王梓翕View::OnUpdateDrawPolyline)
	ON_COMMAND(ID_DRAW_POLYGON, &CCG2D2021113163王梓翕View::OnDrawPolygon)
	ON_UPDATE_COMMAND_UI(ID_DRAW_POLYGON, &CCG2D2021113163王梓翕View::OnUpdateDrawPolygon)
	ON_COMMAND(ID_DRAW_CIRCLE, &CCG2D2021113163王梓翕View::OnDrawCircle)
	ON_UPDATE_COMMAND_UI(ID_DRAW_CIRCLE, &CCG2D2021113163王梓翕View::OnUpdateDrawCircle)
	ON_COMMAND(ID_PICK_ONE, &CCG2D2021113163王梓翕View::OnPickOne)
	ON_UPDATE_COMMAND_UI(ID_PICK_ONE, &CCG2D2021113163王梓翕View::OnUpdatePickOne)
	ON_COMMAND(ID_TRANSLATE_LEFT, &CCG2D2021113163王梓翕View::OnTranslateLeft)
	ON_COMMAND(ID_TRANSLATE_RIGHT, &CCG2D2021113163王梓翕View::OnTranslateRight)
	ON_COMMAND(ID_TRANSLATE_UP, &CCG2D2021113163王梓翕View::OnTranslateUp)
	ON_COMMAND(ID_TRANSLATE_DOWN, &CCG2D2021113163王梓翕View::OnTranslateDown)
	ON_COMMAND(ID_PICK_BOX, &CCG2D2021113163王梓翕View::OnPickBox)
	ON_UPDATE_COMMAND_UI(ID_PICK_BOX, &CCG2D2021113163王梓翕View::OnUpdatePickBox)
	ON_COMMAND(ID_TRANSLATE_ZOOM_IN, &CCG2D2021113163王梓翕View::OnTranslateZoomIn)
	ON_COMMAND(ID_TRANSLATE_ZOOM_OUT, &CCG2D2021113163王梓翕View::OnTranslateZoomOut)
	ON_COMMAND(ID_TRANSLATE_SYM_X, &CCG2D2021113163王梓翕View::OnTranslateSymX)
	ON_COMMAND(ID_TRANSLATE_SYM_Y, &CCG2D2021113163王梓翕View::OnTranslateSymY)
	ON_COMMAND(ID_TRANSLATE_SYM_O, &CCG2D2021113163王梓翕View::OnTranslateSymO)
	ON_COMMAND(ID_TRANSLATE_SYM_XY, &CCG2D2021113163王梓翕View::OnTranslateSymXy)
	ON_COMMAND(ID_TRANSLATE_SYM_XnY, &CCG2D2021113163王梓翕View::OnTranslateSymXny)
	ON_COMMAND(ID_TRANSLATE_MISKNIP_X, &CCG2D2021113163王梓翕View::OnTranslateMisknipX)
	ON_COMMAND(ID_TRANSLATE_MISKNIP_Y, &CCG2D2021113163王梓翕View::OnTranslateMisknipY)
	ON_COMMAND(ID_TRANSLATE_MISKNIP_XY, &CCG2D2021113163王梓翕View::OnTranslateMisknipXy)
	ON_COMMAND(ID_TRANSLATE_MOVE, &CCG2D2021113163王梓翕View::OnTranslateMove)
...
//画笔属性
COLORREF CCG2D2021113163王梓翕View::PenColor() const
{
...
int CCG2D2021113163王梓翕View::PenWidth() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
		return 1;
...
int CCG2D2021113163王梓翕View::PenStyle() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
		return PS_SOLID;
...
//画刷属性
COLORREF CCG2D2021113163王梓翕View::BrushColor() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
...
int CCG2D2021113163王梓翕View::BrushStyle() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
		return 0;
...
int CCG2D2021113163王梓翕View::HatchStyle() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
		return 0;
...
//绘制算法
int CCG2D2021113163王梓翕View::LineAlgorithm() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
		return 0;
...
int CCG2D2021113163王梓翕View::CircleAlgorithm() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
		return 0;
...
int CCG2D2021113163王梓翕View::FillAlgorithm() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
		return 0;
...
int CCG2D2021113163王梓翕View::SeedAlgorithm() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
		return 0;
...
//点阵区域的边界颜色
COLORREF CCG2D2021113163王梓翕View::BoundColor() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
		return 0;
...
//点阵区域的内点颜色
COLORREF CCG2D2021113163王梓翕View::FloodColor() const
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (!pMainWnd)
		return 0;
...
//状态栏上显示提示信息
void CCG2D2021113163王梓翕View::Prompt(const CString& str)
{
	CMainFrame* pMainWnd = (CMainFrame*)AfxGetMainWnd();
	if (pMainWnd != nullptr)
	{
...
void CCG2D2021113163王梓翕View::OnSize(UINT nType, int cx, int cy)
{
...
void CCG2D2021113163王梓翕View::OnDestroy()
{
	__super::OnDestroy();
...
void CCG2D2021113163王梓翕View::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
...
void CCG2D2021113163王梓翕View::OnKeyUp(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	if (mCommand) //命令模式，转发到对应命令对象去处理该事件
...
void CCG2D2021113163王梓翕View::OnLButtonDblClk(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	if (mCommand) //命令模式，转发到对应命令对象去处理该事件
...
void CCG2D2021113163王梓翕View::OnLButtonDown(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	if (mCommand) //命令模式，转发到对应命令对象去处理该事件
...
void CCG2D2021113163王梓翕View::OnLButtonUp(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	if (mCommand) //命令模式，转发到对应命令对象去处理该事件
...
void CCG2D2021113163王梓翕View::OnMButtonDblClk(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	if (mCommand) //命令模式，转发到对应命令对象去处理该事件
...
void CCG2D2021113163王梓翕View::OnMButtonDown(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	if (mCommand) //命令模式，转发到对应命令对象去处理该事件
...
void CCG2D2021113163王梓翕View::OnMButtonUp(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	if (mCommand) //命令模式，转发到对应命令对象去处理该事件
...
void CCG2D2021113163王梓翕View::OnMouseMove(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
...
BOOL CCG2D2021113163王梓翕View::OnMouseWheel(UINT nFlags, short zDelta, CPoint pt)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	if (mCommand) //命令模式，转发到对应命令对象去处理该事件
...
void CCG2D2021113163王梓翕View::OnRButtonDblClk(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	if (mCommand) //命令模式，转发到对应命令对象去处理该事件
...
void CCG2D2021113163王梓翕View::OnRButtonDown(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	if (mCommand) //命令模式，转发到对应命令对象去处理该事件
...
void CCG2D2021113163王梓翕View::OnDrawLinesegment()
{
	// TODO: 在此添加命令处理程序代码
	if (mCommand)
	{
...
void CCG2D2021113163王梓翕View::OnUpdateDrawLinesegment(CCmdUI* pCmdUI)
{
...
void CCG2D2021113163王梓翕View::OnDrawPolyline()
{
	// TODO: 在此添加命令处理程序代码
	if (mCommand)
	{
...
void CCG2D2021113163王梓翕View::OnUpdateDrawPolyline(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	//当前命令是否是绘制直线段命令
...
void CCG2D2021113163王梓翕View::OnDrawPolygon()
{
	// TODO: 在此添加命令处理程序代码
	if (mCommand)
	{
...
void CCG2D2021113163王梓翕View::OnUpdateDrawPolygon(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
...
void CCG2D2021113163王梓翕View::OnDrawCircle()
{
	// TODO: 在此添加命令处理程序代码
	if (mCommand)
	{
...
void CCG2D2021113163王梓翕View::OnUpdateDrawCircle(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
...
//图形对象添加到场景
bool CCG2D2021113163王梓翕View::addRenderable(CG2DRenderable* r)
{
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
	if (!pDoc)
...
bool CCG2D2021113163王梓翕View::delReaderable(CG2DRenderable* r)
{
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
	if (!pDoc)
...
Vec2d CCG2D2021113163王梓翕View::ViewPorttoWorld(const Vec2i& p)
{
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
	if (!pDoc)
...
CG2DRenderable* CCG2D2021113163王梓翕View::UpdatePicked(const Vec2d& p, double radius) //点选
{
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
	if (pDoc)
...
CG2DRenderable* CCG2D2021113163王梓翕View::UpdatePicked(const ABox2d & box, bool inner/* = true*/) //框选（包含才选中？）
{
	CCG2D2021113163王梓翕Doc * pDoc = GetDocument();
	ASSERT_VALID(pDoc);
	if (pDoc)
...
CG2DRenderable* CCG2D2021113163王梓翕View::AppendPicked(const Vec2d& p, double radius) //点选
{
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
	if (pDoc)
...
CG2DRenderable* CCG2D2021113163王梓翕View::AppendPicked(const ABox2d& box, bool inner/* = true*/) //框选（包含才选中？）
{
	CCG2D2021113163王梓翕Doc * pDoc = GetDocument();
	ASSERT_VALID(pDoc);
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnPickOne()
{
	// TODO: 在此添加命令处理程序代码
	if (mCommand)
	{
...
void CCG2D2021113163王梓翕View::OnUpdatePickOne(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	//当前命令是否是拾取图形对象
	pCmdUI->SetCheck(mCommand && mCommand->GetType() == static_cast<int>(CommandType::cmd2dPickRenderable));
}
void CCG2D2021113163王梓翕View::OnPickBox()
{
	// TODO: 在此添加命令处理程序代码
	if (mCommand)
	{
...
void CCG2D2021113163王梓翕View::OnUpdatePickBox(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	//当前命令是否是拾取图形对象
...
void CCG2D2021113163王梓翕View::OnTranslateMove()
{
	// TODO: 在此添加命令处理程序代码
	if (mCommand)
	{
...
void CCG2D2021113163王梓翕View::OnUpdateTranslateMove(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	//当前命令是否是拾取图形对象
...
void CCG2D2021113163王梓翕View::OnTranslateRotate()
{
	// TODO: 在此添加命令处理程序代码
	if (mCommand)
	{
...
void CCG2D2021113163王梓翕View::OnUpdateTranslateRotate(CCmdUI* pCmdUI)
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	//当前命令是否是拾取图形对象
...
void CCG2D2021113163王梓翕View::OnTranslateLeft()
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateRight()
{
	// TODO: 在此添加命令更新用户界面处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateUp()
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateDown()
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateZoomIn() //放大
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateZoomOut() //缩小
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateSymX()
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateSymY()
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateSymO()
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateSymXy()
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateSymXny()
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateMisknipX()
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateMisknipY()
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
...
void CCG2D2021113163王梓翕View::OnTranslateMisknipXy()
{
	// TODO: 在此添加命令处理程序代码
	CCG2D2021113163王梓翕Doc* pDoc = GetDocument();
	if (pDoc)
