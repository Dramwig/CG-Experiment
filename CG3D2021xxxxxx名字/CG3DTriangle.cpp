...
IMPLEMENT_SERIAL(CG3DTriangle, CG3DRenderable, 1)

CG3DTriangle::CG3DTriangle()
	: CG3DClosedFoldedLine(CString("CG3DTriangle"))
{
	mName.Format(_T("三角形-%ld"), sID);
}

CG3DTriangle::CG3DTriangle(const CG3DTriangle& other)
	: CG3DClosedFoldedLine(CString("CG3DTriangle"))
{
	mName.Format(_T("三角形-%ld"), sID);
}
...
//绘制 
void CG3DTriangle::Render(CG3DRenderContext* pRC, CG3DCamera* pCamera)
{
