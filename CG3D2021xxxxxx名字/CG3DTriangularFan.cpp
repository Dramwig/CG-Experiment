...
IMPLEMENT_SERIAL(CG3DTriangularFan, CG3DRenderable, 1)

CG3DTriangularFan::CG3DTriangularFan()
	: CG3DClosedFoldedLine(CString("CG3DTriangularFan"))
{
	mName.Format(_T("三角扇-%ld"), sID);
}

CG3DTriangularFan::CG3DTriangularFan(const CG3DTriangularFan& other)
	: CG3DClosedFoldedLine(CString("CG3DTriangularFan"))
{
	mName.Format(_T("三角扇-%ld"), sID);
}
...
//绘制 
void CG3DTriangularFan::Render(CG3DRenderContext* pRC, CG3DCamera* pCamera)
{
